...
public class RESTBasicTest
{
    ...
    public void createPollTest() throws IOException
    {
        ...
        HttpPost post = new HttpPost("http://localhost:8080/doodle-rest/rest/polls/");
        ...
        Assert.assertEquals( HttpStatus.CREATED.value(), response.getStatusLine().getStatusCode() );
